...
public class ContaGovController {
    ...
    public String processLogin(@ModelAttribute("usuario") ContaGov usuario,
                               RedirectAttributes redirectAttributes) {
        // Verificar se o usuário existe no banco de dados
        ContaGov contaGov = contaGovRepository.findByUsuarioAndSenha(usuario.getUsuario(), usuario.getSenha());
